...
enum EntityType { PLATFORM, PLAYER, ENEMY, BACKGROUND, BULLET, TOKEN};
enum AIType     { WALKER, GUARD};
enum AIState    { WALKING, IDLE, PACING, STANDING};
...
//    bool  m_is_jumping = false;
    ...
    glm::mat4 const get_m_model_matrix() const {return    m_model_matrix;};
    bool      const get_active_status() const {return m_is_active;};
    ...
    void const set_active_status(bool active)               { m_is_active = active;                   };
};
